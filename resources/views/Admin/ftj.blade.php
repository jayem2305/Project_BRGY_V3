...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="Menu-Top" style="margin-top:-2rem; margin-left:15px;">
            ...
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link distinct_cert active" id="ftj" href="../Admin/ftj">
        ...
        <main class="content col">
                ...
                <div class="row gx-2 gy-2 contentadmin">
                    <div class="col-lg-12">
                        <h1 class="p-3 fw-bolder">First Time Job-Seeker Request</h1>
                    </div>
                    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <i class="fas fa-clock fa-3x text-warning"></i> <span class="fa-2x align-top">For Approval <span class="float-end"id="ftj_pending">0</span></span> 
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <i class="fas fa-times-circle fa-3x text-danger"></i> <span class="fa-2x align-top">Unclaimed <span class="float-end"id="ftj_unclaimed">0</span></span>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
            <i class="fas fa-check-circle fa-3x text-success"></i> <span class="fa-2x align-top">Claimed<span class="float-end"id="ftj_claimed">0</span></span>
               <!-- Example number -->
            </div>
        </div>
    </div>
            ...
            <div class="card-body" >
                <div class="row">
                    ...
                    <div class="col-lg-6 text-end"> <!-- Added text-end for right alignment -->
                        ...
                        <button type="button" class="btn btn-primary shadow-lg rounded-pill blue" style="font-size: 1.1rem; padding: 0.5rem 1.5rem; background: linear-gradient(135deg, #0d6efd, #0d6efd); transition: transform 0.2s ease;" data-bs-toggle="modal" data-bs-target="#exampleModalftjcert">
                            <i class="fas fa-plus-circle"></i> Request FTJ
                        </button>
                    </div>
                </div>
      ...
      <div class="modal-dialog modal-xl">
        ...
        <div class="row gy-3">
            ...
            <label for="formGroupExampleInput" class="form-label">Are you a voters of Manila ? <span class="text-danger">*</span></label>
                <select class="form-select form-select-lg mb-3 voters" aria-label="Large select example"name="voters" id="voters_ftj_request">
            ...
            <div class="col-lg-8">
                ...
                <input class="form-control form-control-lg" aria-label="Large select example"name="name-request" id="name_request" >
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control form-control-lg" id="address_request" placeholder="Complete Address" name="address" >
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3">
                        <div class="row">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" class="form-control form-control-lg" id="age_request" placeholder="Age" name="age" min="15" >
                            </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="row">
                            ...
                            <span class="input-group-text" id="basic-addon1">+639</span>
                                <input type="tel" class="form-control form-control-lg" id="cnum_request" placeholder="xx-xxx-xxxx" name="cnum"pattern="[0-9]{2}-[0-9]{3}-[0-9]{4}" maxlength="11" >
                            </div>
                            </div>
                        </div>
                    </div>
            ...
            <label for="formGroupExampleInput" class="form-label">Number of years Resided in the Barangay<span class="text-danger">*</span></label>
                <div class="row g-2">
                    <div class="col-lg-6">
                        <input type="number" class="form-control form-control-lg" value="0" name="numberofliving" id="numberofliving_request" min="0"  >
                    </div>
                    <div class="col-lg-6">
                        <select class="form-select form-select-lg mb-3" aria-label="Large select example"name="typeofdays" id="typeofdays_request">
                            <option selected disabled>-----</option>
            ...
            <div class="col-lg-3">
                ...
                <input type="number" class="form-control form-control-lg" id="copy_ftj_request" max="5" min="1" value="1">
            </div>
            <input type="hidden" class="form-control" name="requirements_request" id="requirements_request_request" value="Approved.pdf">
            <div class="col-lg-9">
            <label for="formGroupExampleInput" class="form-label">Type of First-Time Job Seeker<span class="text-danger">*</span></label>
                <select class="form-select form-select-lg mb-3" aria-label="Large select example"name="ftjtypes" id="ftjtypes_request">
                    <option selected disabled>-----</option>
            ...
            <div class="col-lg-12" style="display: none;" id="minordisplay">
                <div class="row">
                    ...
                    <label for="formGroupExampleInput" class="form-label">Guardian Name: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-lg" placeholder="Guardian's Name" name="pname" id="pname_request" >
                    </div>
                    <div class="col-lg-6">
                    <label for="formGroupExampleInput" class="form-label">Guardians age: <span class="text-danger">*</span></label>
                        <input type="number" class="form-control form-control-lg" placeholder="Guardian Age" name="page" id="page_request" min="18">
                    </div>
                    <div class="col-lg-6">
                    <label for="formGroupExampleInput" class="form-label">Guardians Current Address: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-lg" placeholder="Guardian Current Address" name="paddress" id="paddress_request" >
                    </div>
                    <input type="hidden" class="form-control form-control-lg" id="requirements_parents_ftj_request" value="Approved.pdf">
                </div>
            </div>
...
<script>
// Function to show or hide guardian info based on selected value
document.getElementById('ftjtypes_request').addEventListener('change', function() {
    var selectedValue = this.value;
    var minorDisplay = document.getElementById('minordisplay');
    
    // Show the guardian information form if "First Time Job seeker (Minor)" is selected
    if (selectedValue === "First Time Job seeker (Minor)") {
...
<div class="modal fade" id="declineModal" tabindex="-1" role="dialog" aria-labelledby="declineModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-danger decline_requests" id="submitDeclineReason"><span class='spinner-border spinner-border-sm d-none' role='status' aria-hidden='true'></span>
        <i>Decline</i></button>
      </div>
    </div>
  </div>
