...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="Menu-Top" style="margin-top:-2rem; margin-left:15px;">
            ...
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../admin/project">
        ...
        <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-lg-12">
                    <h1 class="p-1 fw-bolder">Create Barangay Projects</h1>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                        ...
                        <div class="row overflow-auto" style="max-height:25rem; ">
                            <div class="col-lg-12">
                ...
                <div class="col-lg-6">
                    ...
                    <button type="button" class="btn btn-primary project-btn">Submit</button>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h1 class="display-12 mb-5 text-primary"><i>Barangay Project</i></h1>
                        <table class="table table-hover" id="myproject">
                                <thead>
                                    <tr>
