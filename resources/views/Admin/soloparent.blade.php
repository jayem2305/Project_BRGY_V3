@extends('layouts.soloparentAdmin')
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="Menu-Top" style="margin-top:-2rem; margin-left:15px;">
            ...
            <div class="position-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link distinct_cert active" id="soloparent" href="../Admin/soloparent">
        ...
        <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="row gx-2 gy-2 contentadmin">
                    <div class="col-lg-12">
                        <h1 class="p-3 fw-bolder">Solo Parent Certificate Request</h1>
                    </div>
                    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <i class="fas fa-clock fa-3x text-warning"></i> <span class="fa-2x align-top">For Approval <span class="float-end"id="soloparent_pending">0</span></span> 
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <i class="fas fa-times-circle fa-3x text-danger"></i> <span class="fa-2x align-top">Unclaimed <span class="float-end"id="soloparent_unclaimed">0</span></span>
            </div>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
            <i class="fas fa-check-circle fa-3x text-success"></i> <span class="fa-2x align-top">Claimed<span class="float-end" id="soloparent_claimed">0</span></span>
               <!-- Example number -->
            </div>
        </div>
    </div>
            ...
            <div class="card-body" >
                <div class="row">
                    ...
                    <div class="col-lg-6 text-end"> <!-- Added text-end for right alignment -->
                        ...
                        <button type="button" class="btn btn-primary shadow-lg rounded-pill blue" style="font-size: 1.1rem; padding: 0.5rem 1.5rem; background: linear-gradient(135deg, #0d6efd, #0d6efd); transition: transform 0.2s ease;" data-bs-toggle="modal" data-bs-target="#exampleModalsolo-request">
                            <i class="fas fa-plus-circle"></i> Solo Parent Request
                        </button>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered animate__animated animate__zoomIn">
        <div class="modal-content shadow-lg border-0 rounded-3" style="overflow: hidden;">
            ...
            <div class="modal-body text-center">
                ...
                <p class="fs-5">Are you sure you want to approve all <strong>Solo Parent Requests</strong>?</p>
            </div>
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary rounded-pill px-4" data-bs-dismiss="modal">
                    <i class="fas fa-times-circle me-2"></i> Cancel
                </button>
                <button id="confirmApprove" class="btn btn-success shadow-lg rounded-pill green" style="font-size: 1.1rem; padding: 0.5rem 1.5rem; background: linear-gradient(135deg, #28a745, #218838); transition: transform 0.2s ease;" >
...
<div class="modal fade" id="exampleModalsolo-request" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        ...
        <div class="row gy-3">
            ...
            <label for="formGroupExampleInput" class="form-label">Are you a voters of Manila ? <span class="text-danger">*</span></label>
                <select class="form-select form-select-lg mb-3" aria-label="Large select example"name="voters" id="voters_solo_request">
            ...
            <div class="col-lg-8">
                ...
                <input class="form-control form-control-lg mb-3 " name="names_display_request" id="names_display_request" >
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-12">
            ...
            <div class="col-lg-3">
                ...
                <input type="number" class="form-control form-control-lg" id="copy_solo_request" max="5" min="1" value="1">
            </div>
            <input type="hidden" class="form-control" name="requirements_display_request" id="requirements_display_request" value="Approved.pdf">
            <div class="col-lg-9">
            <label for="formGroupExampleInput" class="form-label">Purpose of Barangay Certificate <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-lg" placeholder="Solo Parent" name="soloparent" id="soloparent_request" value="Solo Parent" readonly >
            </div>
            <br>
            <div class="col-lg-12 ">
                <label for="childNameInput" class="form-label text-primary">Enter your child's name:<span class="text-danger">*</span></label>
                <div class="input-group mb-3">
                <input type="text" id="childNameInput" class="form-control form-control-lg" placeholder="Enter full name" aria-label="Child's username" aria-describedby="addChildButton">
                <button class="btn btn-primary" type="button" id="addChildButton">Add Child</button>
               
                </div>
            </div>
            <div id="childrenList" class="mt-3">
                <h5>Children List:</h5>
                <ul id="childrenNames"></ul>
            </div>
        </div>
    </div>
</div>
