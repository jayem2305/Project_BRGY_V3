  ...
  <body>
   ...
   <script src="../lib/wow/wow.min.js"></script>
    ...
    $(document).ready(function() {
            ...
            endpoints.forEach((url, index) => {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#cert_unclaimed').text(response.Readytoclaimcount);
                        $('#cert_claimed').text(response.claimcount);
                    },
                    error: function(xhr, status, error) {
                        console.error(error);
                    }
        ...
        var type = 'certificate'; // Example type
...
$(document).ready(function() {
    ...
    $('.printall').click(function() {
        ...
        //alert(officer);
        $.ajax({
            url: '/generate-all-approved-pdfs-cert', // The route you defined in web.php
            type: 'POST',
            data: {
...
$(document).ready(function () {
    $('#confirmApprove').click(function () {
        var requestType = 'Barangay Certificate'; // Change this dynamically if needed
...
$('.upload-certifictae').click(function (e) {
    ...
    toggleSpinner(button, true);
    e.preventDefault();
    var voters = $('#voters_cert_request').val();
    ...
    var copy = $('#copy_cert_request').val();
    var purpose = $('#purposes').val();
    var otherpurpose = $('#otherpurpose').val();
    var fileInput = $('#requirements_request').val();
    ...
    $.ajax({
        url: '{{ route("Admin.submit.certificate.request") }}',
        type: 'POST',
        data: formData,
        headers: {
        ...
        toggleSpinner(button, false);
           // displaytable();
            ...
            $('.toast').toast('show');
            $('#exampleModalCertificate-request').modal('hide');
