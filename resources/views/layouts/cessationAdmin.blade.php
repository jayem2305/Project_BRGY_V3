  ...
  <body>
   ...
   <script src="../lib/wow/wow.min.js"></script>
    ...
    $(document).ready(function() {
            ...
            endpoints.forEach((url, index) => {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#cessation_unclaimed').text(response.Readytoclaimcount);
                        $('#cessation_claimed').text(response.claimcount);
                    },
                    error: function(xhr, status, error) {
                        console.error(error);
                    }
        ...
        var type = 'cessation'; // Example type
                ...
                success: function(response) {
                    ...
                    if (response.length === 0) {
                        ...
                        $.each(response, function(index, item) {
                            ...
                            var address = item.baddress;
                            var purpose = item.bname;
...
$(document).ready(function() {
    ...
    $('.printall').click(function() {
        ...
        //alert(officer);
        $.ajax({
            url: '/generate-all-approved-pdfs-cessation', // The route you defined in web.php
            type: 'POST',
            data: {
...
$(document).ready(function () {
    $('#confirmApprove').click(function () {
        var requestType = 'Business Cessation'; // Change this dynamically if needed
    ...
    toggleSpinner(button, true);
    e.preventDefault();
    var voters = $('#voters_cessation_request').val();
    ...
    var copy = $('#copy_cessation_request').val();
    var bname = $('#cbname_request').val();
    var CEOname = $('#CEOname_request').val();
    var cbaddress = $('#cbaddress_request').val();
    var fileInput = $('#requirements_display_request').val();
    ...
    formData.append('baddress', cbaddress);
    formData.append('requirements', fileInput);
    var csrfToken = $('meta[name="csrf-token"]').attr('content');
    $.ajax({
        url: '{{ route("Admin.submit.cessation.request") }}',
        type: 'POST',
        data: formData,
        headers: {
        ...
        toggleSpinner(button, false);
            ...
            $('.toast').toast('show');
            $('#modalBcessation-request').modal('hide');
